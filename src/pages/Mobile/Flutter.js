...
import awspic from '../../assets/flutterpage.png'
                                    ...
                                    <Box sx={{ lineHeight: "10", pt: '40px' }}>
                                        <Box>
                                            <Typography variant='h3' sx={{ fontWeight: "800", color: "white", fontSize: { lg: '50px', xs: '30px' } }}>
                                                Hire Flutter<Box style={{ color: MAIN_COLOR, fontWeight: 900, fontSize: { lg: '80px', xs: '40px' }, backgroundColor: 'black', padding: '0px 0px', borderRadius: '10px', width: 'fit-content' }}>Developers</Box>
                                            </Typography>
                                            <Typography sx={{ color: "white", mt: "20px", fontSize: { lg: "15px", xs: '13px', md: '18px' }, fontFamily: 'lora' }}>
                                                Get Zero Headache Flutter Developers who are ready to take your project within 24 hours and carry out project development efficiently by following the best Adnroid development practices. We, at AdelSocial, leave no stone unturned in delivering bug-free and high-performance Adnroid solutions.
                                            </Typography>
                    ...
                    <Box sx={{ display: "flex", justifyContent: "center", mb: '20px' }} data-aos="fade-up">
                        <Box sx={{ width: { xs: "90%", sm: "90%", md: "70%", lg: "80%" }, mt: "20px" }}>
                            <Typography  align='center' sx={{fontSize:{lg:"33px",md:"30px",sm:"28px",xs:"22px"}, fontWeight: "800", color: MAIN_COLOR }} >
                                We Build Scalable Flutter Solutions for All Business Verticals
                            </Typography>
                            <Typography sx={{  fontSize: { lg: "15px", xs: '13px', md: '15px',sm:"14px" },textAlign: { xs: "", sm: "", md: "center", lg: "center" }, mt: "10px" }}>
                                When you hire Flutter app developers from AdelSocial, you hire a team of Flutter specialists that holds expertise in developing Flutter solutions for a diverse range of industry verticals.
                            </Typography>
                        </Box>
                    </Box>
