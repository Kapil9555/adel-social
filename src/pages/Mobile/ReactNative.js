...
import awspic from '../../assets/reactnative.jpg'
        ...
        <>
            ...
            <Container disableGutters maxWidth={'xl'}>
                <Grid container>
                      ...
                      {/* new section  */}
                      <Grid container>
                        <Grid item xs={12} sx={{ backgroundImage: `url(${awspic})`, bgcolor: 'rgb(90,90,90)', backgroundSize: '100% 100%', backgroundRepeat: 'no-repeat', backgroundBlendMode: "multiply", backgroundPosition: 'center', p: { lg: "50px", md: "50px", sm: "30px 15px", xs: "30px 10px" } }}>
                                    ...
                                    <Box sx={{ lineHeight: "10", pt: '40px' }}>
                                        <Box>
                                            <Typography variant='h3' sx={{ fontWeight: "800", color: "white", fontSize: { lg: '50px', xs: '30px' } }}>
                                                Hire ReactNative<Box style={{ color: MAIN_COLOR, fontWeight: 900, fontSize: { lg: '80px', xs: '40px' }, backgroundColor: 'black', padding: '0px 0px', borderRadius: '10px', width: 'fit-content' }}>Developers</Box>
                                            </Typography>
                                            <Typography sx={{ color: "white", mt: "20px", fontSize: { lg: "15px", xs: '13px', md: '18px' }, fontFamily: 'lora' }}>
                                                Get Zero Headache ReactNative Developers who are ready to take your project within 24 hours and carry out project development efficiently by following the best Adnroid development practices. We, at AdelSocial, leave no stone unturned in delivering bug-free and high-performance Adnroid solutions.
                                            </Typography>
                    ...
                    <Box sx={{ display: "flex", justifyContent: "center", mb: '20px' }} data-aos="fade-up">
                        <Box sx={{ width: { xs: "90%", sm: "90%", md: "70%", lg: "80%" }, mt: "20px" }}>
                            <Typography  align='center' sx={{fontSize:{lg:"33px",md:"30px",sm:"28px",xs:"22px"}, fontWeight: "800", color: MAIN_COLOR }} >
                                We Build Scalable React Native Solutions for All Business Verticals
                            </Typography>
                            <Typography sx={{  fontSize: { lg: "15px", xs: '13px', md: '15px',sm:"14px" },textAlign: { xs: "", sm: "", md: "center", lg: "center" }, mt: "10px" }}>
                                When you hire React Native app developers from AdelSocial, you hire a team of React Native specialists that holds expertise in developing React Native solutions for a diverse range of industry verticals.
                            </Typography>
                        </Box>
                    </Box>
