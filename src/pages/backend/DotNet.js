...
const DotNet = () => {
    ...
    const Technologies1 = ["ASP.NET MVC", " .NET Core", " .NET Core Rest API", "C#", " .NET Framework 4.8", " .NET Framework 4.7", " .NET Framework 4.6", "  WinForms", " .NET Framework 4.5", " .NET Framework 4.0", "  VB.NET", "  Microservices", "  VS Add-ins", "  Azure Development", "  WinForms", "  WPF", "  WCF Services", "  WCF Data Services", "  JSON", "  SOAP", "  REST API", "  Kendo UI", "  SQL Server 2019", "  2017", "2016", "2014", "2012", "  JSON"]

    const Technologies3 = ["Authorize.NET ", " Stripe", " PayPal", "CareConnect", "Adyen", "FirstData", "MiGS", "DocuSign ", " Chart (amChart", " Google", "D3.js ", "Echarts", "AWS &amp; Azure Services ", "Google Map Services", " Live Streaming Services ","Authorize.NET "]
                                ...
                                <Box sx={{ lineHeight: "10", pt: '40px' }}>
                                    <Box>
                                        <Typography variant='h3' sx={{ fontWeight: "800", color: "white", fontSize: { lg: '50px', xs: '30px' } }}>
                                            Hire DOT NET <Box style={{ color: MAIN_COLOR, fontWeight: 900, fontSize: { lg: '80px', xs: '40px' }, backgroundColor: 'black', padding: '0px 0px', borderRadius: '10px', width: 'fit-content' }}>Developers</Box>
                                        </Typography>
                                        <Typography sx={{ color: "white", mt: "20px", fontSize: { lg: "15px", xs: '13px', md: '18px' } }}>
                                            Get Zero Headache Dot NET Developers who are ready to take your project within 24 hours and carry out project development efficiently by following the best Dot NET development practices. We, at AdelSocial, leave no stone unturned in delivering bug-free and high-performance .NET solutions.
                                        </Typography>
                    ...
                    <Grid className='dotnetPage'  container sx={{ borderRadius: "60px", pb: '20px', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', width: { xs: "100%", sm: "99.2%", md: "99%", lg: "83%" } }}>
                        <Grid item xs={12} sx={{  mb: "20px", display: "flex", justifyContent: "center" ,borderRadius:'20px' }}>
                            <Box sx={{ width: { xs: "90%", sm: "90%", md: "70%", lg: "80%" }, mt: "50px" }}>
                                <Typography sx={{ fontSize:{lg:"33px",md:"30px",sm:"28px",xs:"22px"}, fontWeight: "800", color: MAIN_COLOR }} >
                                    Our Complete Suite of Dot NET Development Services
                                </Typography>
                                <Typography sx={{ color: 'white', fontSize: { xs: '12px', lg: '18px' } }}>
                                    Our Dot NET development services include everything from .NET web app development to .NET CMS development to desktop app development and much more. Dedicated .NET developers at AdelSocial are highly skilled and capable of building high-end .NET solutions that will take your business a few notches higher.
                                </Typography>
                ...
                <Grid item xs={12} sx={{ pb: "40px", bgcolor: "#f1f1f1", display: "flex", justifyContent: "center" }}>
                    <Box sx={{ width: { xs: "90%", sm: "90%", md: "70%", lg: "80%" }, mt:"15px",textAlign:{xs:"",sm:"",md:"center",lg:"center"} }}>
                        <Typography sx={{fontSize:{lg:"33px",md:"30px",sm:"28px",xs:"22px"}, fontWeight: "900", color: MAIN_COLOR }} >
                            Why Hire Dot NET Programmers for Your Web Development Project?
                        </Typography>
                    ...
                    <Box sx={{ display: "flex", justifyContent: "center", mb: '80px' }}>
                        <Box sx={{ width: { xs: "90%", sm: "90%", md: "70%", lg: "80%" }, mt: "20px" }}>
                            ...
                            <Typography sx={{ textAlign: { xs: "", sm: "", md: "center", lg: "center" },fontSize: { xs: '12px', lg: '16px'}, mt: "20px" }}>
                                When you hire.NET app developers from AdelSocial, you hire a team of.NET specialists that holds expertise in developing.NET solutions for a diverse range of industry verticals.
                            </Typography>
                        </Box>
                    </Box>
                    ...
                    <Box sx={{ display: "flex", justifyContent: "center" }}>
                        <Box sx={{ width: { xs: "90%", sm: "90%", md: "70%", lg: "80%" }, mt: "50px" }}>
                            <Typography sx={{ fontSize:{lg:"33px",md:"30px",sm:"28px",xs:"22px"}, fontWeight: "800", color: "white" }} >
                                Hire Dot NET Developers at AdelSocial in 4 Easy Steps
                            </Typography>
                        </Box>
                    </Box>
                    ...
                    <Box sx={{ width: { xs: "90%", sm: "90%", md: "70%", lg: "80%" } }}>
                        ...
                        <Box>
                            ...
                            <Accordion elevation={0}>
                                ...
                                >
                                    <Typography sx={{ color: "black", fontSize: "18px", fontWeight: "800" }}>
                                        What if I’m not satisfied with your .NET solution?
                                    </Typography>
                                </AccordionSummary>
                                <AccordionDetails>
                                    <Typography>
                            ...
                            <Accordion elevation={0}>
                                ...
                                >
                                    <Typography sx={{ color: "black", fontSize: "18px", fontWeight: "800" }}>
                                        How do I find the best Dot NET development company?
                                    </Typography>
                                </AccordionSummary>
                                <AccordionDetails>
                                    <Typography>

                                        Before finalizing the Dot NET development company, you need to look out for certain factors that wll help you make the right decision for your project. Some of the factors you need to look for are the company’s experience, work portfolio, clientele, client testimonials, technology stack, awards and recognitions, and many others.
                                    </Typography>
                                </AccordionDetails>
                            </Accordion>
                            ...
                            <Accordion elevation={0}>
                                ...
                                >
                                    <Typography sx={{ color: "black", fontSize: "18px", fontWeight: "800" }}>
                                        What are types of software can I develop using .NET?
                                    </Typography>
                                </AccordionSummary>
                                <AccordionDetails>
                                    <Typography>
                                        .NET can be used for developing websites, web applications, web portals, CRMs, CMS, and many more.
                            ...
                            <Accordion elevation={0}>
                                ...
                                >
                                    <Typography sx={{ color: "black", fontSize: "18px", fontWeight: "800" }}>
                                        How do you charge for hiring a .NET developer
                                    </Typography>
                                </AccordionSummary>
                                <AccordionDetails>
                                    <Typography>
                                        The estimated cost for hiring a .NET developer will depend on the number of years of experience a developer has and the complexity and size of the project.
                                        Have More Questions? Please Feel Free to Ask Our Team of Dot NET Experts.
                                    </Typography>
                                </AccordionDetails>
                            </Accordion>
                        </Box>
