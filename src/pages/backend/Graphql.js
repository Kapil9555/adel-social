...
const GraphQL = () => {
    ...
    const netInfo = [{
        ...
        title: "Hire Dedicated GraphQL Developers",
        about: "Our dedicated GraphQL developers build robust, scalable, and secure web portals, desktop apps, and CMS for enterprises that are built to meet their business objectives."
    },
    {
    ...
    const Technologies1 = ["ASPGraphQL MVC", " GraphQL Core", " GraphQL Core Rest API", "C#", " GraphQL Framework 4.8", " GraphQL Framework 4.7", " GraphQL Framework 4.6", " GraphQL Framework 4.5", " GraphQL Framework 4.0", "  VBGraphQL", "  Microservices", "  VS Add-ins", "  Azure Development", "  WinForms", "  WPF", "  WCF Services", "  WCF Data Services", "  JSON", "  SOAP", "  REST API", "  Kendo UI", "  SQL Server 2019", "  2017", "2016", "2014", "2012"]

    const Technologies3 = ["AuthorizeGraphQL ", " Stripe", " PayPal", "CareConnect", "Adyen", "FirstData", "MiGS", "DocuSign ", " Chart (amChart", " Google", "D3.js ", "Echarts", "AWS &amp; Azure Services ", "Google Map Services", " Live Streaming Services "]
        ...
        <Container disableGutters maxWidth={'xl'}>
                            ...
                            <Box sx={{ lineHeight: "10", pt: '40px' }}>
                                <Box>
                                    <Typography variant='h3' sx={{ fontWeight: "800", color: "white", fontSize: { lg: '50px', xs: '30px' } }}>
                                        Hire GraphQl <Box style={{ color: MAIN_COLOR, fontWeight: 900, fontSize: { lg: '80px', xs: '40px' }, backgroundColor: 'black', padding: '0px 0px', borderRadius: '10px', width: 'fit-content' }}>Developers</Box>
                                    </Typography>
                                    <Typography sx={{ color: "white", mt: "20px", fontSize: { lg: "15px", xs: '13px', md: '18px' } }}>
                                        Get Zero Headache GraphQl Developers who are ready to take your project within 24 hours and carry out project development efficiently by following the best GraphQl development practices. We, at AdelSocial, leave no stone unturned in delivering bug-free and high-performance GraphQl solutions.
                                    </Typography>
            ...
            <Grid item xs={12} sx={{ pb: "40px", bgcolor: "#f1f1f1", display: "flex", justifyContent: "center" }}>
                <Box sx={{ borderRadius: '60px', boxShadow: '3px 4px 21px 1px rgba(0,0,0,0.75)', bgcolor: 'white', width: { xs: "95%", sm: "95%", md: "95%", lg: "80%" }, mt: "50px", p: '30px' }}>
                    <Typography sx={{ fontSize:{lg:"33px",md:"30px",sm:"28px",xs:"22px"}, fontWeight: "800", color: MAIN_COLOR }} >
                        Looking to Hire GraphQl Developers? You’re at the Right Spot
                    </Typography>
                    <Typography sx={{ fontSize: { xs: '12px', lg: '16px', }, color: '#212121',mt:"10px" }}>
                        Are you in pursuit of a dedicated GraphQl developer for your project? Our highly-qualified GraphQl developers are just a click away. We have a pool of talented, proactive, and competent GraphQl developers who have great expertise in GraphQl development and can deliver tailored solutions to meet your unique business requirements. Our dedicated GraphQl Developers follow a neatly refined and up-to-the-mark technical approach. You can hire highly skilled GraphQl developers at AdelSocial as we have built proficiency in GraphQl development over years with our extensive web development experiences. All these years, we have focused on accumulating the best GraphQl developers from different regions to offer you to hire GraphQl developers to meet your project goals using vast knowledge and skills.
                        <br />
                        <br />
                        With our first-rate hire GraphQl developer services, you are given the liberty to choose a GraphQl developer from our team of GraphQl programmers with different levels of expertise and experience. We can help you fulfill all your business requirements and objectives by letting you hire GraphQl programmers, in the best equations of time and cost. Hiring GraphQl developers, at AdelSocial, means you are relieved from unnecessary cost-bills, stress, and solutions with superior quality and performance.
                    </Typography>
                </Box>
            </Grid>
                ...
                <Grid className='dotnetPage'  container sx={{ borderRadius: "60px", pb: '20px', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', width: { xs: "100%", sm: "99.2%", md: "99%", lg: "83%" } }}>
                    <Grid item xs={12} sx={{  mb: "20px", display: "flex", justifyContent: "center" ,borderRadius:'20px' }}>
                        <Box sx={{ width: { xs: "90%", sm: "90%", md: "70%", lg: "80%" }, mt: "50px" }}>
                            <Typography sx={{ fontSize:{lg:"33px",md:"30px",sm:"28px",xs:"22px"}, fontWeight: "800", color: MAIN_COLOR }} >
                                Our Complete Suite of GraphQl Development Services
                            </Typography>
                            <Typography sx={{ color: 'white', fontSize: { xs: '12px', lg: '18px' } }}>
                                Our GraphQl development services include everything from GraphQl web app development to GraphQl CMS development to desktop app development and much more. Dedicated GraphQl developers at AdelSocial are highly skilled and capable of building high-end GraphQl solutions that will take your business a few notches higher.
                            </Typography>
            ...
            <Grid item xs={12} sx={{ pb: "40px", bgcolor: "#f1f1f1", display: "flex", justifyContent: "center" }}>
                <Box sx={{ width: { xs: "90%", sm: "90%", md: "70%", lg: "80%" }, mt:"15px",textAlign:{xs:"",sm:"",md:"center",lg:"center"} }}>
                    <Typography sx={{fontSize:{lg:"33px",md:"30px",sm:"28px",xs:"22px"}, fontWeight: "900", color: MAIN_COLOR }} >
                        Why Hire GraphQl Programmers for Your Web Development Project?
                    </Typography>
                    <Typography sx={{ mt: "14px",fontSize: { xs: '12px', lg: '16px'} }}>
                        The GraphQl software framework, developed by Microsoft, has gained popularity in the web development industry as it allows the creation of feature-rich web applications in a quick time. Here are a few reasons why you should opt for GraphQl development for your web development project.
                    </Typography>
            ...
            <Grid className='dotnetPage' item xs={12} sx={{ pb: "40px", display: "flex", justifyContent: "center", mt: '0px', pt: '30px' }}>
                <Box sx={{ width: { xs: "90%", sm: "90%", md: "70%", lg: "80%" } }}>
                    <Typography sx={{ fontSize:{lg:"33px",md:"30px",sm:"28px",xs:"22px"}, fontWeight: "800", color: MAIN_COLOR }} >
                        GraphQl Technologies We Use
                    </Typography>
                    <Typography sx={{ fontSize: { xs: '12px', lg: '16px'},color: 'white'  }}>Our GraphQl developers have an iron grip of core and advanced GraphQl technologies to facilitate the agile development of quality-oriented web apps for your business. Some of the cutting-edge GraphQl technologies and tools we work on include:</Typography>
            ...
            <Grid item xs={12} sx={{ pb: "15px" }}>
                <Box sx={{ display: "flex", justifyContent: "center", mb: '80px' }}>
                    <Box sx={{ width: { xs: "90%", sm: "90%", md: "70%", lg: "80%" }, mt: "20px" }}>
                        <Typography sx={{fontSize:{lg:"33px",md:"30px",sm:"28px",xs:"22px"}, fontWeight: "800", color: MAIN_COLOR }} >
                            We Build Scalable GraphQl Solutions for All Business Verticals
                        </Typography>
                        <Typography sx={{ textAlign: { xs: "", sm: "", md: "center", lg: "center" },fontSize: { xs: '12px', lg: '16px'}, mt: "20px" }}>
                            When you hireGraphQl app developers from AdelSocial, you hire a team ofGraphQl specialists that holds expertise in developingGraphQl solutions for a diverse range of industry verticals.
                        </Typography>
                    </Box>
                </Box>
                        ...
                        <Grid item xs={12} sm={12} md={6} lg={4}>
                            <Card sx={{ maxWidth: 400, p: "15px", m: "15px", boxShadow: '3px 4px 21px 1px rgba(0,0,0,0.75)', }} elevation={5}  >
                                <CardActionArea>
                                    ...
                                    <CardContent >
                                        <Typography gutterBottom sx={{ fontSize: "25px", fontWeight: "800", color: MAIN_COLOR }} >
                                            Hire GraphQl Developer by Hour
                                        </Typography>
                                        <Typography sx={{ fontSize: '14px' }}>
                                            Lizards are a widespread group of squamate reptiles, with over 6,000
                                            species, ranging across all continents except Antarctica
                ...
                <Box sx={{ display: "flex", justifyContent: "center" }}>
                    <Box sx={{ width: { xs: "90%", sm: "90%", md: "70%", lg: "80%" }, mt: "50px" }}>
                        <Typography sx={{ fontSize:{lg:"33px",md:"30px",sm:"28px",xs:"22px"}, fontWeight: "800", color: "white" }} >
                            Hire GraphQl Developers at AdelSocial in 4 Easy Steps
                        </Typography>
                    </Box>
                </Box>
                ...
                <Box sx={{ width: { xs: "90%", sm: "90%", md: "70%", lg: "80%" } }}>
                    ...
                    <Box>
                        ...
                        <Accordion elevation={0}>
                            ...
                            >
                                <Typography sx={{ color: "black", fontSize: "18px", fontWeight: "800" }}>
                                    What if I’m not satisfied with your GraphQl solution?
                                </Typography>
                            </AccordionSummary>
                            <AccordionDetails>
                                <Typography>
                        ...
                        <Accordion elevation={0}>
                            ...
                            <AccordionDetails>
                                <Typography>
                                    ...
                                    We are available on all communication channels such as Microsoft Teams, Google Meet, Zoom Call, Phone, Live Chats, and Emails to keep you informed of the current status of your GraphQl development project.
                                </Typography>
                            </AccordionDetails>
                        </Accordion>
                        ...
                        <Accordion elevation={0}>
                            ...
                            >
                                <Typography sx={{ color: "black", fontSize: "18px", fontWeight: "800" }}>
                                    How much does it cost to develop a GraphQl project?
                                </Typography>
                            </AccordionSummary>
                            <AccordionDetails>
                                <Typography>
                                    The development cost of a GraphQl-based project depends on the industry type, industry compliance, design complexity, the number of features and integrations you want within your app, the experience level of the GraphQl developer, location, and many more. You may get in touch with us to request a free no-obligation quote for your project.
                                </Typography>
                            </AccordionDetails>
                        </Accordion>
                        ...
                        <Accordion elevation={0}>
                            ...
                            >
                                <Typography sx={{ color: "black", fontSize: "18px", fontWeight: "800" }}>
                                    How do I find the best GraphQl development company?
                                </Typography>
                            </AccordionSummary>
                            <AccordionDetails>
                                <Typography>

                                    Before finalizing the GraphQl development company, you need to look out for certain factors that wll help you make the right decision for your project. Some of the factors you need to look for are the company’s experience, work portfolio, clientele, client testimonials, technology stack, awards and recognitions, and many others.
                                </Typography>
                            </AccordionDetails>
                        </Accordion>
                        ...
                        <Accordion elevation={0}>
                            ...
                            >
                                <Typography sx={{ color: "black", fontSize: "18px", fontWeight: "800" }}>
                                    What are types of software can I develop using GraphQl?
                                </Typography>
                            </AccordionSummary>
                            <AccordionDetails>
                                <Typography>
                                    GraphQl can be used for developing websites, web applications, web portals, CRMs, CMS, and many more.
                        ...
                        <Accordion elevation={0}>
                            ...
                            >
                                <Typography sx={{ color: "black", fontSize: "18px", fontWeight: "800" }}>
                                    How do you charge for hiring a GraphQl developer
                                </Typography>
                            </AccordionSummary>
                            <AccordionDetails>
                                <Typography>
                                    The estimated cost for hiring a GraphQl developer will depend on the number of years of experience a developer has and the complexity and size of the project.
                                    Have More Questions? Please Feel Free to Ask Our Team of GraphQl Experts.
                                </Typography>
                            </AccordionDetails>
                        </Accordion>
                    </Box>
