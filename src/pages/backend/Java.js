...
const Java = () => {
    ...
    const Technologies1 = ["ASPJava MVC", " Java Core", " Java Core Rest API", "C#", " Java Framework 4.8", " Java Framework 4.7", " Java Framework 4.6", " Java Framework 4.5", " Java Framework 4.0", "  VBJava", "  Microservices", "  VS Add-ins", "  Azure Development", "  WinForms", "  WPF", "  WCF Services", "  WCF Data Services", "  JSON", "  SOAP", "  REST API", "  Kendo UI", "  SQL Server 2019", "  2017", "2016", "2014", "2012"]

    const Technologies3 = ["AuthorizeJava ", " Stripe", " PayPal", "CareConnect", "Adyen", "FirstData", "MiGS", "DocuSign ", " Chart (amChart", " Google", "D3.js ", "Echarts", "AWS &amp; Azure Services ", "Google Map Services", " Live Streaming Services "]
        ...
        <Container disableGutters maxWidth={'xl'}>
                            ...
                            <Box sx={{ lineHeight: "10", pt: '40px' }}>
                                <Box>
                                    <Typography variant='h3' sx={{ fontWeight: "800", color: "white", fontSize: { lg: '50px', xs: '30px' } }}>
                                        Hire Java <Box style={{ color: MAIN_COLOR, fontWeight: 900, fontSize: { lg: '80px', xs: '40px' }, backgroundColor: 'black', padding: '0px 0px', borderRadius: '10px', width: 'fit-content' }}>Developers</Box>
                                    </Typography>
            ...
            <Grid className='dotnetPage' item xs={12} sx={{ pb: "40px", display: "flex", justifyContent: "center", mt: '0px', pt: '30px' }}>
                <Box sx={{ width: { xs: "90%", sm: "90%", md: "70%", lg: "80%" } }}>
                    ...
                    <Typography sx={{ fontSize: { xs: '12px', lg: '16px'},color: 'white'  }}>Our Java developers have an iron grip of core and advanced Java technologies to facilitate the agile development of quality-oriented web apps for your business. Some of the cutting-edge Java technologies and tools we work on include:</Typography>
