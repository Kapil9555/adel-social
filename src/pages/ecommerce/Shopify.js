...
const Shopify = () => {
    ...
    const netInfo = [{
        ...
        title: "Hire Dedicated Shopify Developers",
        about: "Our dedicated Shopify developers build robust, scalable, and secure web portals, desktop apps, and CMS for enterprises that are built to meet their business objectives."
    },
    {
    ...
    const Technologies1 = ["ASPShopify MVC", " Shopify Core", " Shopify Core Rest API", "C#", " Shopify Framework 4.8", " Shopify Framework 4.7", " Shopify Framework 4.6", " Shopify Framework 4.5", " Shopify Framework 4.0", "  VBShopify", "  Microservices", "  VS Add-ins", "  Azure Development", "  WinForms", "  WPF", "  WCF Services", "  WCF Data Services", "  JSON", "  SOAP", "  REST API", "  Kendo UI", "  SQL Server 2019", "  2017", "2016", "2014", "2012"]

    const Technologies3 = ["AuthorizeShopify ", " Stripe", " PayPal", "CareConnect", "Adyen", "FirstData", "MiGS", "DocuSign ", " Chart (amChart", " Google", "D3.js ", "Echarts", "AWS &amp; Azure Services ", "Google Map Services", " Live Streaming Services "]
        ...
        <Container disableGutters maxWidth={'xl'}>
                            ...
                            <Box sx={{ lineHeight: "10", pt: '40px' }}>
                                <Box>
                                    <Typography variant='h3' sx={{ fontWeight: "800", color: "white", fontSize: { lg: '50px', xs: '30px' } }}>
                                        Hire Shopify <Box style={{ color: MAIN_COLOR, fontWeight: 900, fontSize: { lg: '80px', xs: '40px' }, backgroundColor: 'black', padding: '0px 0px', borderRadius: '10px', width: 'fit-content' }}>Developers</Box>
                                    </Typography>
                                    <Typography sx={{ color: "white", mt: "20px", fontSize: { lg: "15px", xs: '13px', md: '18px' } }}>
                                        Get Zero Headache Shopify Developers who are ready to take your project within 24 hours and carry out project development efficiently by following the best Shopify development practices. We, at AdelSocial, leave no stone unturned in delivering bug-free and high-performance Shopify solutions.
                                    </Typography>
            ...
            <Grid item xs={12} sx={{ pb: "40px", bgcolor: "#f1f1f1", display: "flex", justifyContent: "center" }}>
                <Box sx={{ borderRadius: '60px', boxShadow: '3px 4px 21px 1px rgba(0,0,0,0.75)', bgcolor: 'white', width: { xs: "95%", sm: "95%", md: "95%", lg: "80%" }, mt: "50px", p: '30px' }}>
                    <Typography sx={{ fontSize:{lg:"33px",md:"30px",sm:"28px",xs:"22px"}, fontWeight: "800", color: MAIN_COLOR }} >
                        Looking to Hire Shopify Developers? You’re at the Right Spot
                    </Typography>
                    <Typography sx={{ fontSize: { xs: '12px', lg: '16px', }, color: '#212121',mt:"10px" }}>
                        Are you in pursuit of a dedicated Shopify developer for your project? Our highly-qualified Shopify developers are just a click away. We have a pool of talented, proactive, and competent Shopify developers who have great expertise in Shopify development and can deliver tailored solutions to meet your unique business requirements. Our dedicated Shopify Developers follow a neatly refined and up-to-the-mark technical approach. You can hire highly skilled Shopify developers at AdelSocial as we have built proficiency in Shopify development over years with our extensive web development experiences. All these years, we have focused on accumulating the best Shopify developers from different regions to offer you to hire Shopify developers to meet your project goals using vast knowledge and skills.
                        <br />
                        <br />
                        With our first-rate hire Shopify developer services, you are given the liberty to choose a Shopify developer from our team of Shopify programmers with different levels of expertise and experience. We can help you fulfill all your business requirements and objectives by letting you hire Shopify programmers, in the best equations of time and cost. Hiring Shopify developers, at AdelSocial, means you are relieved from unnecessary cost-bills, stress, and solutions with superior quality and performance.
                    </Typography>
                </Box>
            </Grid>
                    ...
                    <Grid item xs={12} sx={{  mb: "20px", display: "flex", justifyContent: "center" ,borderRadius:'20px' }}>
                        <Box sx={{ width: { xs: "90%", sm: "90%", md: "70%", lg: "80%" }, mt: "50px" }}>
                            ...
                            <Typography sx={{ color: 'white', fontSize: { xs: '12px', lg: '18px' } }}>
                                Our Shopify development services include everything from Shopify web app development to Shopify CMS development to desktop app development and much more. Dedicated Shopify developers at AdelSocial are highly skilled and capable of building high-end Shopify solutions that will take your business a few notches higher.
                            </Typography>
            ...
            <Grid item xs={12} sx={{ pb: "40px", bgcolor: "#f1f1f1", display: "flex", justifyContent: "center" }}>
                <Box sx={{ width: { xs: "90%", sm: "90%", md: "70%", lg: "80%" }, mt:"15px",textAlign:{xs:"",sm:"",md:"center",lg:"center"} }}>
                    <Typography sx={{fontSize:{lg:"33px",md:"30px",sm:"28px",xs:"22px"}, fontWeight: "900", color: MAIN_COLOR }} >
                        Why Hire Shopify Programmers for Your Web Development Project?
                    </Typography>
                    <Typography sx={{ mt: "14px",fontSize: { xs: '12px', lg: '16px'} }}>
                        The Shopify software framework, developed by Microsoft, has gained popularity in the web development industry as it allows the creation of feature-rich web applications in a quick time. Here are a few reasons why you should opt for Shopify development for your web development project.
                    </Typography>
            ...
            <Grid className='dotnetPage' item xs={12} sx={{ pb: "40px", display: "flex", justifyContent: "center", mt: '0px', pt: '30px' }}>
                <Box sx={{ width: { xs: "90%", sm: "90%", md: "70%", lg: "80%" } }}>
                    <Typography sx={{ fontSize:{lg:"33px",md:"30px",sm:"28px",xs:"22px"}, fontWeight: "800", color: MAIN_COLOR }} >
                        Shopify Technologies We Use
                    </Typography>
                    <Typography sx={{ fontSize: { xs: '12px', lg: '16px'},color: 'white'  }}>Our Shopify developers have an iron grip of core and advanced Shopify technologies to facilitate the agile development of quality-oriented web apps for your business. Some of the cutting-edge Shopify technologies and tools we work on include:</Typography>
            ...
            <Grid item xs={12} sx={{ pb: "15px" }}>
                <Box sx={{ display: "flex", justifyContent: "center", mb: '80px' }}>
                    <Box sx={{ width: { xs: "90%", sm: "90%", md: "70%", lg: "80%" }, mt: "20px" }}>
                        <Typography sx={{fontSize:{lg:"33px",md:"30px",sm:"28px",xs:"22px"}, fontWeight: "800", color: MAIN_COLOR }} >
                            We Build Scalable Shopify Solutions for All Business Verticals
                        </Typography>
                        <Typography sx={{ textAlign: { xs: "", sm: "", md: "center", lg: "center" },fontSize: { xs: '12px', lg: '16px'}, mt: "20px" }}>
                            When you hireShopify app developers from AdelSocial, you hire a team ofShopify specialists that holds expertise in developingShopify solutions for a diverse range of industry verticals.
                        </Typography>
                    </Box>
                </Box>
                        ...
                        <Grid item xs={12} sm={12} md={6} lg={4}>
                            <Card sx={{ maxWidth: 400, p: "15px", m: "15px", boxShadow: '3px 4px 21px 1px rgba(0,0,0,0.75)', }} elevation={5}  >
                                <CardActionArea>
                                    ...
                                    <CardContent >
                                        <Typography gutterBottom sx={{ fontSize: "25px", fontWeight: "800", color: MAIN_COLOR }} >
                                            Hire Shopify Developer by Hour
                                        </Typography>
                                        <Typography sx={{ fontSize: '14px' }}>
                                            Lizards are a widespread group of squamate reptiles, with over 6,000
                                            species, ranging across all continents except Antarctica
                ...
                <Box sx={{ display: "flex", justifyContent: "center" }}>
                    <Box sx={{ width: { xs: "90%", sm: "90%", md: "70%", lg: "80%" }, mt: "50px" }}>
                        <Typography sx={{ fontSize:{lg:"33px",md:"30px",sm:"28px",xs:"22px"}, fontWeight: "800", color: "white" }} >
                            Hire Shopify Developers at AdelSocial in 4 Easy Steps
                        </Typography>
                    </Box>
                </Box>
                ...
                <Box sx={{ width: { xs: "90%", sm: "90%", md: "70%", lg: "80%" } }}>
                    ...
                    <Box>
                        ...
                        <Accordion elevation={0}>
                            ...
                            >
                                <Typography sx={{ color: "black", fontSize: "18px", fontWeight: "800" }}>
                                    What if I’m not satisfied with your Shopify solution?
                                </Typography>
                            </AccordionSummary>
                            <AccordionDetails>
                                <Typography>
                        ...
                        <Accordion elevation={0}>
                            ...
                            <AccordionDetails>
                                <Typography>
                                    ...
                                    We are available on all communication channels such as Microsoft Teams, Google Meet, Zoom Call, Phone, Live Chats, and Emails to keep you informed of the current status of your Shopify development project.
                                </Typography>
                            </AccordionDetails>
                        </Accordion>
                        ...
                        <Accordion elevation={0}>
                            ...
                            >
                                <Typography sx={{ color: "black", fontSize: "18px", fontWeight: "800" }}>
                                    How much does it cost to develop a Shopify project?
                                </Typography>
                            </AccordionSummary>
                            <AccordionDetails>
                                <Typography>
                                    The development cost of a Shopify-based project depends on the industry type, industry compliance, design complexity, the number of features and integrations you want within your app, the experience level of the Shopify developer, location, and many more. You may get in touch with us to request a free no-obligation quote for your project.
                                </Typography>
                            </AccordionDetails>
                        </Accordion>
                        ...
                        <Accordion elevation={0}>
                            ...
                            >
                                <Typography sx={{ color: "black", fontSize: "18px", fontWeight: "800" }}>
                                    How do I find the best Shopify development company?
                                </Typography>
                            </AccordionSummary>
                            <AccordionDetails>
                                <Typography>

                                    Before finalizing the Shopify development company, you need to look out for certain factors that wll help you make the right decision for your project. Some of the factors you need to look for are the company’s experience, work portfolio, clientele, client testimonials, technology stack, awards and recognitions, and many others.
                                </Typography>
                            </AccordionDetails>
                        </Accordion>
                        ...
                        <Accordion elevation={0}>
                            ...
                            >
                                <Typography sx={{ color: "black", fontSize: "18px", fontWeight: "800" }}>
                                    What are types of software can I develop using Shopify?
                                </Typography>
                            </AccordionSummary>
                            <AccordionDetails>
                                <Typography>
                                    Shopify can be used for developing websites, web applications, web portals, CRMs, CMS, and many more.
                        ...
                        <Accordion elevation={0}>
                            ...
                            >
                                <Typography sx={{ color: "black", fontSize: "18px", fontWeight: "800" }}>
                                    How do you charge for hiring a Shopify developer
                                </Typography>
                            </AccordionSummary>
                            <AccordionDetails>
                                <Typography>
                                    The estimated cost for hiring a Shopify developer will depend on the number of years of experience a developer has and the complexity and size of the project.
                                    Have More Questions? Please Feel Free to Ask Our Team of Shopify Experts.
                                </Typography>
                            </AccordionDetails>
                        </Accordion>
                    </Box>
