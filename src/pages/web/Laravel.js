                            ...
                            <Box sx={{ lineHeight: "10" }}>
                                <Box>
                                    ...
                                    <Typography sx={{ color: "white", mt: "20px", fontSize: "20px" }}>
                                        Develop an intuitive &amp; feature-rich website with the experienced, well-versed, &amp; skilled assistance of Laravel developers.
                                    </Typography>
                                    <Box sx={{ mt: "40px" }}>
            ...
            <Grid container sx={{ p: "20px" }}>
                ...
                <Grid item xs={12} md={5} lg={5}>
                    <Typography sx={{ fontSize: "35px", fontWeight: "800", color: MAIN_COLOR }} >
                        Hire Dedicated Laravel Developers with Flexibility
                    </Typography>
                    <Typography sx={{ mt: "10px", fontSize: "18px" }}>
                        Laravel has long dominated the world of website development and blogging. It’s the single most popular website builder. According to Laravel.org, 38% of the entire web is built on Laravel. Small businesses and Fortune 500 companies alike use the framework for building and managing their digital ecosystem.
                    </Typography>
                    <Typography sx={{ fontSize: "18px" }}>
                        We nurture a team of experienced Laravel developers who can efficiently fulfill your digital solution requirements. Their years-long experience of working in multiple industry verticals helps them build the right solution for you. Whether you want to launch a personal blog, a business website, or an online store, you can hire a dedicated Laravel developer to meet your needs.
                    </Typography>
                    ...
                    <Grid xs={12} item sx={{ display: "flex", justifyContent: "center" }}>
                        <Box >
                            ...
                            <Typography align='center' sx={{ fontSize: "20px", fontWeight: "400", fontFamily: "Tisa Sans Pro sans-serif !important" }}>
                                When you hire Laravel developers from us, the scope of your digital world becomes virtually limitless. We offer an extensive range of design, development, and tech support services for all kinds of needs.
                            </Typography>
                        </Box>
                    </Grid>
